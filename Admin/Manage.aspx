           ...
           <div>
                        <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource2" EnableModelValidation="True" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" GridLines="Both" Width="200%" OnItemUpdated="FormView1_ItemUpdated">
                            <EditItemTemplate>
                                ...
                                <asp:SqlDataSource ID="ddlusername" runat="server" ConnectionString="<%$ ConnectionStrings:ISBEPI_DEV %>" SelectCommand="  SELECT UN.Name, UN.NameID FROM UserNames un JOIN [dbo].[aspnet_UsersInRoles] UR  ON UR.UserId = un.UserId  
                                WHERE UR.RoleId ='E7F4D35C-8C43-48A0-99E1-8CF724F80ABD';"></asp:SqlDataSource>
