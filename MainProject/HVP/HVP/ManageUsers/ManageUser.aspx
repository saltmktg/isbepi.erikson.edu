...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div>
            <asp:gridview runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" EnableModelValidation="True" ForeColor="Black" GridLines="Vertical" DataSourceID="SqlDataSource1">
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="LastLoginDate" DataField="LastLoginDate" DataFormatString="{0:r}" SortExpression="LastLoginDate" />
                </Columns>
  ...
  INNER JOIN [ISBEPI_DEV].[dbo].[aspnet_Roles] Roles ON Roles.RoleId = staff.RoleId 
  INNER JOIN [ISBEPI_DEV].[dbo].[aspnet_Membership] Member ON Member.UserId = staff.UserId"></asp:SqlDataSource>
        </div>
        </div>
</asp:Content>
