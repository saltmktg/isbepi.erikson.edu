...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <div class="userlist">
    ...
    <table>            
       ...
       <%-- <tr>
            <th>
                Select Second Monitor (Optional) :</th>            
            <td>          
                <asp:DropDownList ID="ddlSeconduser" runat="server">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlSeconduser" Display="Dynamic" ErrorMessage="*" Font-Size="Large" ForeColor="Red" ValidationGroup="valGroup1"></asp:RequiredFieldValidator>
            </td>                    
        </tr> --%>
        ...
        <th>Select Program Name:</th>                     
            <td>           
	          ...
	          <%--  <script type="text/javascript">
                ...
                <div class="ui-widget"><asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></div>--%>
        ...
        <tr>            
            <td></td>
            <td>                   
                <asp:PlaceHolder ID="PHSiteError" runat="server"></asp:PlaceHolder>
            </td>
        </tr>
        <tr>            
            <th>
        ...
        <Columns>
            <asp:BoundField DataField="SiteID" HeaderText="Site ID" Visible="True" />
        ...
        <tr>
            <td colspan="5">
                <asp:PlaceHolder ID="PHError1" runat="server"></asp:PlaceHolder>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                 <asp:LinkButton ID="lnkbtnPICC" runat="server" OnClick="lnkbtnPICC_Click">PICC</asp:LinkButton>
            </td>
        </tr>
    </table>
        </asp:View>
...
&nbsp;</th>
        ...
        <asp:View ID="View4" runat="server">
            ...
            <h4>
               Site Name:
                <asp:Label ID="lblStatusSIteName" runat="server" ForeColor="#006600"></asp:Label>
            </h4>
            <h4>
                Monitor Name:
                <asp:Label ID="lblStatusMonitorName" runat="server" ForeColor="#006600"></asp:Label>
            </h4>
            <h4>
                Program Survey Completed:
                <asp:Label ID="lblStatusPD" runat="server" ForeColor="#006600"></asp:Label>
            </h4>
            <h4>
                Home Visitor Survey Completed:
                <asp:Label ID="lblStausHVS" runat="server" ForeColor="#006600"></asp:Label>
            </h4>
            <h4>
                Change Status:
                ...
                <asp:PlaceHolder ID="PHError3" runat="server"></asp:PlaceHolder>
                </div>
            <table>
                <tr>
                    <td>
