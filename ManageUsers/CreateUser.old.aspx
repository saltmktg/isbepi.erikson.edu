...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div><h1 class="users">Create User</h1></div>       
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlSites"  Width="200px" runat="server" DataSourceID="SqlDataSource2" DataTextField="Sites" DataValueField="SiteID"  Visible="False">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="* Required" ValidationGroup="CreateVal" ControlToValidate="ddlSites"></asp:RequiredFieldValidator>
