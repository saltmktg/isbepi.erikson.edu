...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <h1 class="users">Disable User</h1>
         ...
         <div style="float:left; margin-right:.5em;">
             <asp:LinkButton ID="lnkDisable" CssClass="pos-down-1" runat="server" OnClick="lnkDisable_Click">Disable</asp:LinkButton>
        </div>
         <div style="float:left; margin-right:.5em;">
             <asp:LinkButton ID="lbkUnDisable" CssClass="pos-down-1" runat="server" OnClick="lbkUnDisable_Click">Un-Disable</asp:LinkButton>
        </div>
        <br />
