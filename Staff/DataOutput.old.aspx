<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramDirector/DirectorSurvey.Master" AutoEventWireup="true" CodeBehind="DataOutput.aspx.cs" Inherits="HVP.ProgramDirector.DataOutput" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:SqlDataSource ID="SqlDataSource19" runat="server" ConnectionString="<%$ ConnectionStrings:ISBEPI_DEV %>" SelectCommand="SELECT [SiteID], [Sites] FROM [Sites] WHERE ([SiteID] = @SiteID)">
            <SelectParameters>
                <asp:ControlParameter ControlID="hfSiteID" Name="SiteID" PropertyName="Value" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
    <h3 class="finaltoolTitle">Site ID/Name: <asp:Label ID="lblSiteName" runat="server"></asp:Label></h3>
     <h2>Review Survey</h2>    
    <h3>DEMOGRAPHICS</h3>
            ...
            <ol start ="7">
                ...
                <br />
                  <li>
                      ...
                      <ul> 
                      <li><asp:TextBox ID="txtQ10_1" runat="server" onkeyup="sumQ10();" Enabled="False"></asp:TextBox>Not yet born 
                          </li>
                      <li><asp:TextBox ID="txtQ10_2" runat="server" onkeyup="sumQ10();" Enabled="False"></asp:TextBox>0­-12 
                          </li>
                      <li><asp:TextBox ID="txtQ10_3" runat="server" onkeyup="sumQ10();" Enabled="False"></asp:TextBox>13-24</li>
                      <li><asp:TextBox ID="txtQ10_4" runat="server" onkeyup="sumQ10();" Enabled="False"></asp:TextBox>25-36 Months</li>
                     <li> <asp:TextBox ID="txtQ10_5" runat="server" onkeyup="sumQ10();" Enabled="False"></asp:TextBox>Older than 36 Months 
                          </li> 
...
***Mentorship means that the staff position was teamed with a seasoned professional with specific expertise in carrying out the job responsibilities. This definition implies an on­ going relationship over a period of time, where multiple opportunities for consultation and guidance are present to support individual growth and development. A two month job shadowing period where there is no on­going guidance once job responsibilities are assumed would not meet this definition.
                ...
                <li>
                    ...
                    <table class="HVSurvey">
                       <%-- <tr>
                        ...
                        <tr>
                            <td class="HVSurvey" style="height: 48px"><asp:Label ID="lblQ20_1_2" runat="server"></asp:Label></td>
           ...
           <asp:UpdatePanel ID="UpdatePanel2" runat="server">
             ...
             <ol start="16"><li>
                ...
                <li runat="server" id ="Q23"><asp:Label ID="lblQ23" runat="server"></asp:Label>
