...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h4>SELECT SITE:<asp:dropdownlist runat="server" ID="ddlSites" DataSourceID="SqlDataSource1" DataTextField="Sites" DataValueField="Schd_ID"></asp:dropdownlist>
     ...
     <div style="width: 100%; height: 400px; overflow: scroll" class="data-table">
         <asp:datagrid runat="server" ID="DataGrid1" CssClass="Grid2"></asp:datagrid>
