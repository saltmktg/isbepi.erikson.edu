                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        <asp:View ID="View1" runat="server">
                            <div style="clear: both; border-top: solid 2px;">
							  <div runat="server" id ="primaryMonitor_edit">
                                <h4>
                        ...
                        JOIN [dbo].[aspnet_UsersInRoles] UR  ON UN.UserId = UR.UserId 
                        JOIN aspnet_Membership Member ON Member.UserId = UN.UserId 
                        WHERE UR.RoleId = 'E7F4D35C-8C43-48A0-99E1-8CF724F80ABD' AND Member.IsApproved =1 ORDER BY Name;"></asp:SqlDataSource>
                            </div>
                            <div>
                                <h4>
                            ...
                            <div style="float: right; margin: 10px;">
                                <asp:LinkButton ID="lnkaddChageMonitor" runat="server" OnClick="lnkaddChageMonitor_Click">Add/Change Monitor</asp:LinkButton></div>
                        </asp:View>
                    </asp:MultiView>
                    <div style="clear: both; float: right;">
                        <asp:LinkButton ID="lnkbtnChangeMonitor" runat="server" OnClick="lnkbtnChangeMonitor_Click">Add/Change Monitor</asp:LinkButton></div>
                </ContentTemplate>
            </asp:UpdatePanel>
