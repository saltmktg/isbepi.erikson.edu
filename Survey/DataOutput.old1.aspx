<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/SurveyMaster.Master" AutoEventWireup="true" CodeBehind="DataOutput.aspx.cs" Inherits="HVP.Survey.DataOutput" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3 class="finaltoolTitle">Site ID/Name:
        <asp:Label ID="lblSiteName" runat="server"></asp:Label></h3>
    <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:ISBEPI_DEV %>" SelectCommand="SELECT [SiteID], [Sites] FROM [Sites] WHERE ([SiteID] = @SiteID)">
        <SelectParameters>
    ...
    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataRepeater1">
        ...
        <ItemTemplate>
            <tr>
                <td class="HVSurvey">
                    <ol start="<%# Container.ItemIndex + 12 %>">
                        <li>
    ...
    <asp:Repeater ID="Repeater2" runat="server" DataSourceID="SqlDataRepeater2">
        ...
        <ItemTemplate>
            <tr>
                <td class="HVSurvey">
                    <ol start="<%# Container.ItemIndex + 20 %>">
                        <li>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Question") %>'></asp:Label>
                        </li>
                    </ol>
    ...
    <asp:Repeater ID="Repeater3" runat="server" DataSourceID="SqlDataRepeater3">
        ...
        <ItemTemplate>
            <tr>
                <td class="HVSurvey">
                    <ol start="<%# Container.ItemIndex + 24 %>">
                        <li>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Question") %>'></asp:Label>
                        </li>
                    </ol>
    ...
    <asp:Repeater ID="Repeater4" runat="server" DataSourceID="SqlDataRepeater4">
        ...
        <ItemTemplate>
            <tr>
                <td class="HVSurvey">
                    <ol start="<%# Container.ItemIndex + 28 %>">
                        <li>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Question") %>'></asp:Label>
                        </li>
                    </ol>
    ...
    <asp:Repeater ID="Repeater5" runat="server" DataSourceID="SqlDataRepeater5">
        ...
        <ItemTemplate>
            <tr>
                <td class="HVSurvey">
                    <ol start="<%# Container.ItemIndex + 32 %>">
                        <li>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Question") %>'></asp:Label>
                        </li>
                    </ol>
    ...
    <asp:Repeater ID="Repeater6" runat="server" DataSourceID="SqlDataRepeater6">
        ...
        <ItemTemplate>
            <tr>
                <td class="HVSurvey">
                    <ol start="<%# Container.ItemIndex + 36 %>">
                        <li>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Question") %>'></asp:Label>
                        </li>
                    </ol>
    ...
    <asp:Repeater ID="Repeater7" runat="server" DataSourceID="SqlDataRepeater7">
        ...
        <ItemTemplate>
            <tr>
                <td class="HVSurvey">
                    <ol start="<%# Container.ItemIndex + 56 %>">
                        <li>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Question") %>'></asp:Label>
                        </li>
                    </ol>
    ...
    <asp:Repeater ID="Repeater8" runat="server" DataSourceID="SqlDataRepeater8">
        ...
        <ItemTemplate>
            <tr>
                <td class="HVSurvey">
                    <ol start="<%# Container.ItemIndex + 59 %>">
                        <li>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Question") %>'></asp:Label>
                        </li>
                    </ol>
    ...
    <ol start="63">
        <li>
            <asp:Label ID="lblQ64" runat="server"></asp:Label>&nbsp;
                                  <asp:CheckBoxList ID="CheckBoxList64" runat="server" DataSourceID="SqlDataSource9" DataTextField="Answers" DataValueField="Value" Enabled="False" CssClass="chk64">
                                  </asp:CheckBoxList>
