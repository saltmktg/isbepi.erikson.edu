<%@ Page Title="" Language="C#" MasterPageFile="~/ManageSiteViewReport.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="HVP.ViewReports._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="userlist">
   <div> <h1 class="users">Manage Sites: View Reports</h1></div>    
